...
def get_cifar10(args, data_file):
    ...
    base_dataset = datasets.Cifar10(data_file=data_file, mode='train', download=True)
    ...
    train_labeled_dataset = CIFAR10SSL(
        data_file, train_labeled_idxs, mode='train',
        transform=transform_labeled)

    train_unlabeled_dataset = CIFAR10SSL(
        data_file, train_unlabeled_idxs, mode='train',
        transform=TransformFixMatch(mean=cifar10_mean, std=cifar10_std))

    test_dataset = datasets.Cifar10(
        data_file=data_file, mode='test', transform=transform_val, download=True)
